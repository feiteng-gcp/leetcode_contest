...
def get_user_rating_US(USERNAME, USER_RATING_RECORD):
    file_name = 'User_Rating/' + USERNAME + '.json'
...
def get_user_rating_CN(USERNAME, USER_RATING_RECORD):
    file_name = 'User_Rating/' + USERNAME + '.json'
    file_content = IO_Helper.loadJSON(file_name)
